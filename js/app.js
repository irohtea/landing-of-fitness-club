(() => {
    ...
    function counter() {
        function digitsCounterInit(digitsCountersInitItems) {
            ...
            if (digitsCounters && digitsCounters.length) digitsCounters.forEach((digitsCounter => {
        ...
        let observer = new IntersectionObserver(((entries, observer) => {
            entries.forEach((entry => {
                if (entry.isIntersecting) {
                    ...
                    if (digitsCountersItems.length) digitsCounterInit(digitsCountersItems);
                }
            }));
        }), options);
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            navigation: {
                prevEl: ".controls-swiper__button-prev",
                nextEl: ".controls-swiper__button-next"
            },
            on: {}
        });
    }
